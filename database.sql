...
('23', 'Large companies have demonstrated string interest and willingness to commit to acquistion', '5'),
...
('36', 'Low retentionL the business model requires time to develop higher retention', '2'),
